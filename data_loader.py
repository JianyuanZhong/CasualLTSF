...
class Dataset_ETT_hour(Dataset):
    def __init__(self, root_path, taskid=0, size=None,
    ...
    def __read_data__(self):
        ...
        # print(f"taskid: {self.taskid}, b1: {border1}, b2: {border2}")
...
class Dataset_Custom(Dataset):
    def __init__(self, root_path, taskid='train', size=None,
                 features='S', data_path='ETTh1.csv',
    ...
    def __read_data__(self):
        ...
        border1s_ = [0, num_train - self.seq_len, len(df_raw) - num_test - self.seq_len]
        border2s_ = [num_train, num_train + num_vali, len(df_raw)]
